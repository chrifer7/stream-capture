...
def getPorts(searchst,st):
  ...
  pat2=re.compile('\d+')
  mstring=pat.findall(str(st))[0] # matched string .. #Python 3 -> str() "client_port=1000-1001"
...
print ()
s.send(dest.encode()) #Python 3 -> .encode()
recst=s.recv(4096)
print ()
print ("*** GOT ****")
print ()
...
print ("*** SENDING SETUP ***")
print ()
s.send(setu.encode()) #Python 3 -> .encode()
recst=s.recv(4096)
print ()
print ("*** GOT ****")
print ()
...
s.send(play.encode()) #Python 3 -> .encode()
recst=s.recv(4096)
print ()
print ("*** GOT ****")
print ()
